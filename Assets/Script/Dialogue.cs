...
public class Dialogue : MonoBehaviour
{
    ...
    public Manager sn;
    public managerchp2 sn2;
    public managerchp3 sn3;
    public int count;
...
CantFindNodeLoopPoint:
		...
		if (nestedRunTexts <= 0)
		{
            ...
            {
                case 1:
                    sn.CloseMotherDialogue();
                    break;
                case 2:
                    sn.DestroyCatDialogue();
                    break;
                case 3:
                    sn.DestroyTeenDialogue();
                    break;
                case 4:
                    sn.DestroyJakeDialogue();
                    break;
                case 5:
                    sn.CloseZebraCrossingDialogue();
                    break;
                case 6:
                    sn.NotGoingBackDialogue();
                    break;
                case 7:
                    sn.CloseEndChapterDialogue();
                    break;
                case 8:
                    sn2.DestroyGrandmaDialogue();
                    break;
                case 9:
                    sn2.DestroyGrandma2Dialogue();
                    break;
                case 10:
                    sn2.DestroyJake2Dialogue();
                    break;
                case 11:
                    sn3.DestroyGoHomeDialogue();
                    break;
                case 12:
                    sn3.DestroyWalkPathDialogue();
                    break;
                case 13:
                    sn3.DestroyKidnapperDialogue();
                    break;
                case 14:
                    sn2.CloseEndChapterDialogue();
                    break;
                case 15:
                    sn3.CloseEndChapterDialogue();
                    break;
                case 16:
                    sn.CloseFirstDialogue();
                    break;
            }
